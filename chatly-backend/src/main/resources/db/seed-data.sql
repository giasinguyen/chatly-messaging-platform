...
VALUES 
    ...
    (gen_random_uuid(), 'nguyenvana@email.com', '$2a$10$I4b1825dVqvKGT/WgIO9ZObSuogcvHcApLq1ntWrf/F3uxGLYsF6G', 'Nguyễn Văn A', 'https://i.pravatar.cc/150?img=1', '+84901234567', 'Yêu thích công nghệ và lập trình. Thích du lịch và khám phá những điều mới mẻ.', 'ONLINE', NOW(), NOW(), NOW()),
    ...
    (gen_random_uuid(), 'ngok@email.com', '$2a$10$I4b1825dVqvKGT/WgIO9ZObSuogcvHcApLq1ntWrf/F3uxGLYsF6G', 'Ngô Thị K', 'https://i.pravatar.cc/150?img=10', '+84900123456', 'Marketing specialist, yêu thích sáng tạo nội dung. Thích yoga và meditation.', 'OFFLINE', NOW(), NOW(), NOW())
