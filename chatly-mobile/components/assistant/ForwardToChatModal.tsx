...
export function ForwardToChatModal({
  visible,
  currentUserId,
  onClose,
  onConfirm,
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setConversations(conversationRes.result ?? []);
        setUsers(
      ...
      >
        ...
        >
          ...
          <Text className="mt-1 text-sm" style={{ color: Colors.textMuted }}>
            Select a conversation. Content will be filled into the composer for review.
          </Text>
          ...
          <View className="mt-4 flex-row gap-3">
            ...
            <TouchableOpacity
              ...
              style={{
                backgroundColor: selectedId && !loading ? Colors.cta : Colors.borderLight,
              }}
